           ...
           <section class="content">
            <div class="container_fluid"><!--inicio del contenido-->
              ...
              <table id="creditos_cauto" class="table-hover table-bordered" width="100%">
               <thead style="background:#034f84;color:white;text-align:center;font-family: Helvetica, Arial, sans-serif;font-size: 11px;">
                 <tr>
                  <th>No. Venta</th>
...
<input type="hidden" id="name_pag" value="COBROS DE CARGO AUTOMATICO">
